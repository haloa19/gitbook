...
public class TimelineApiController {
	...
	public void addUpload(@PathVariable String id, @PathVariable Optional<Long> groupNo,
	...
	public void timelineUpdate(@PathVariable String id, @PathVariable Long timelineNo,
			@RequestParam(value = "userNo", required = true) Long userNo,
			@RequestParam(value = "contents", required = true) String contents,
			@RequestParam(value = "visible", required = true) String visible,
			@RequestParam(value = "tagList", required = true) ArrayList<String> tagList,
	...
	public JsonResult addUpload(@PathVariable String id, @RequestParam MultipartFile file) {
	...
	public JsonResult groupTimelineList(@PathVariable Long id, @PathVariable Long groupNo) {
	...
	public JsonResult mainTimelineList(@AuthUser UserVo userVo, @PathVariable String id) {
	...
	public JsonResult tagTimelineList(@AuthUser UserVo userVo, @PathVariable String id, @PathVariable String tagid) {
	...
	public void deleteTimeline(@PathVariable Long timelineNo) {
	...
	public JsonResult timelineUserNo(
			...
			@PathVariable Long userNo, @PathVariable Long timelineNo
	...
	public JsonResult addlike(
			...
			@PathVariable Long authUserNo, @PathVariable Long timelineNo
	...
	public JsonResult deletecomment(
			...
			@PathVariable Long CommentNo, @PathVariable Long TimelineNo) {
