...
public class ChattingApiController {
	...
	public JsonResult addchatRoom(@PathVariable Long userNo,
		...
		for (Long no : inviteList) {
			...
			for (ChattingRoomVo vo1 : list) {
				...
				if (chattingService.getAdminImage(vo1.getNo()) == null) {
					map.put("image", "/gitbook/assets/img/users/default.jpg");
				} else {
					map.put("image", chattingService.getAdminImage(vo1.getNo()).getImage());
				}
	...
	public JsonResult chatRoomList(@PathVariable Long userNo
		...
		for (ChattingRoomVo vo : list) {
			...
			if (chattingService.getAdminImage(vo.getNo()) == null) {
				...
				map.put("image", chattingService.getAdminImage(vo.getNo()).getImage());
			}
	...
	public JsonResult chatRoomListItmeInfo(@PathVariable Long chatRoonNo, @AuthUser UserVo userVo
	...
	public JsonResult chatRoomInfo(@PathVariable Long chatRoonNo, @AuthUser UserVo userVo) {
		...
		for (ChattingRoomVo vo1 : list) {
			...
			if (chattingService.getAdminImage(vo1.getNo()) == null) {
				...
				map2.put("image", chattingService.getAdminImage(vo1.getNo()).getImage());
			}
...
//			}
	...
	public void deleteChatRoom(@PathVariable Long userNo, @PathVariable Long chatRoonNo,
		...
		for (Long no : inviteList) {
			...
			for (ChattingRoomVo vo : list) {
				...
				if (chattingService.getAdminImage(vo.getNo()) == null) {
					...
					map2.put("image", chattingService.getAdminImage(vo.getNo()).getImage());
				}
...
//				chattingService.getLastMsg(chatRoonNo));
	...
	public JsonResult getInviteList(@PathVariable Long chatRoonNo) {
	...
	public void addinviteUser(@PathVariable Long userNo, @PathVariable Long chatRoonNo,
